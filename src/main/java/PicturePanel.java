 ...
 * The picture grid
 * 
 * Note: This is a Moore state machine. Check the enum States to see the
 * different modes it can be in.
 *
 * Methods of interest
 * ----------------------
 * newGame(int dimension) - Reset the board and set grid size to dimension x
 * dimension
...
public class PicturePanel extends JPanel {
  ...
  public static class InvalidCoordinateException extends Exception {
    ...
    public String toString() {
      return "Board size is " + actualRows + "x" + actualColumns + ". Invalid coordinate: (" + attemptedRow + ", "
          + attemptedColumn + ")";
    }
  }
